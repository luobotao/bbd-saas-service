		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 bbd-md-3">
				...
				<%
					...
					if (user != null) {
						if (UserRole.SITEMASTER.equals(user.getRole())) {
				%>
					...
					<li id="tostore" class="lv1"><a href="<c:url value="/holdToStoreController" />" target="iframe1" ><i class="b-icon p-error"></i>揽件入库</a></li>
