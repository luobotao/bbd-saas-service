			...
			<div class="b-detail col-xs-12 col-sm-12 col-md-9 col-lg-9">
				...
				<form class="form-inline form-inline-n">
					<div class="search-area">
						...
						<div class="row pb20">
							<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
								<a href="javascript:void(0)" class="ser-btn l" onclick="showCourierDiv()">选择派件员</a>
							...
							<div class="form-group col-xs-12 col-sm-6 col-md-5 col-lg-5">
								<label>扫描运单号：</label>
								<input type="text" id="mailNum" name="mailNum" type="text" placeholder="请扫描运单号" class="form-control"  />
