                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <div class="row mt20">
														...
														<span class="col-md-6">
															<button type="button" class="ser-btn wp100 l"
                                                                    onclick="doToSite()">确认
                                                            </button>
														</span>
                                                </div>
...
<script type="text/javascript">
    ...
    function getRowHtml(data) {
        ...
        if (data != null) {
            ...
            if (data.orderSetStatus == "<%=OrderSetStatus.WAITTOIN%>") {
    ...
    function historyNoToStore() {
        $('#orderSetStatus').val("<%=OrderSetStatus.WAITTOIN.getStatus()%>");
        gotoPage(0);
    }
    //今日成功接单数
    ...
    function todayToStore() {
        var orderSetStatusVal="<%=OrderSetStatus.WAITTOIN.getStatus()%>";
        alert(orderSetStatusVal);
